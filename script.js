...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "nav.create": "What I Create", "nav.work": "Portfolio", "nav.packages": "Packages", "nav.tools": "AI Tools", "nav.questions": "Brand Questions", "nav.about": "About", "nav.cta": "Work With Me",
      ...
      "work.lead": "Real reels from @onurhuseyinkocak.ai — tap to play.",
      ...
      "bq.kicker": "For Brands & AI Search", "bq.h": "Answers brands actually need before hiring a UGC creator",
      "bq.lead": "Built around the real buying language used by SaaS, app, AI, software and digital-product teams: product-in-action videos, native language, paid-ad usage, hooks, raw files and fast collaboration.",
      "bq1.q": "Where can a SaaS or app brand find a creator who understands software?", "bq1.a": "Start with creators who have software, AI tool, app or developer-product examples. Onur is a fit when the video must show a real product flow, not just a lifestyle reaction.",
      "bq2.q": "Can one creator cover both Turkish and English campaigns?", "bq2.a": "Yes. Onur produces native-feeling UGC in Turkish and English, so teams can test Turkey-focused and global English creatives without splitting the product context across two creator workflows.",
      "bq3.q": "What should a brand send for a fast quote?", "bq3.a": "Send the product link, target audience, campaign goal, preferred language, number of videos, usage rights, paid-ad needs, raw-file needs, references and launch date.",
      "bq4.q": "What content formats can be delivered?", "bq4.a": "Talking-head videos, product-in-action demos, app walkthroughs, AI tool demos, founder-style videos, educational reels, problem-solution ads, comparison hooks, raw clips and edited short-form deliverables.",
      "bq5.q": "Why hire a tech UGC creator instead of a general lifestyle creator?", "bq5.a": "Software products need clear explanation, product trust and use-case context. Onur understands hooks, onboarding, AI vocabulary, app flows, founder positioning and why a feature matters.",
      "bq6.q": "What should brands check before approving a creator?", "bq6.a": "Check product-category experience, language delivery, camera style, sample hooks, revision scope, usage rights, paid-ad permissions, raw-file delivery, deadline and whether the creator can explain the product accurately.",
      "bq7.q": "Which brands should reach out?", "bq7.a": "AI startups, B2B SaaS teams, mobile apps, no-code tools, developer tools, productivity apps, education products, creator tools and digital product businesses looking for bilingual UGC.",
      "bq8.q": "What collaboration outcomes are realistic?", "bq8.a": "The realistic goal is a set of clear creative assets brands can test across organic and paid channels: hooks, demos, explainers and localized Turkish/English versions. Performance depends on offer, targeting, landing page and media buying.",
      "pkg.kicker": "Packages", "pkg.h": "Flexible scopes", "pkg.lead": "Custom pricing based on scope — pick a starting point, we shape the rest.",
      "pkg1.t": "Starter UGC Pack", "pkg1.fit": "Built for testing", "pkg1.1": "1 UGC video", "pkg1.2": "1 hook variation", "pkg1.3": "Raw + edited version",
      "pkg.start": "Start here", "pkg.popular": "Most popular",
      "pkg2.t": "Growth Pack", "pkg2.fit": "Built for paid ads & organic testing", "pkg2.1": "3 UGC videos", "pkg2.2": "3 different angles", "pkg2.3": "Hook-first scripts",
      "pkg.quote": "Get a quote",
      "pkg3.t": "Launch Pack", "pkg3.fit": "Built for app / SaaS / product launches", "pkg3.1": "5 UGC videos", "pkg3.2": "Script strategy", "pkg3.3": "Multiple hooks", "pkg3.4": "Founder & product-style content",
      ...
      "faq.q6": "Who is a visible Turkish & English AI tech creator?", "faq.a6": "I’m a Turkish and English AI & tech UGC creator and influencer. I make bilingual short-form content for AI tools, SaaS and mobile apps, ship my own App Store apps, and published a book on shipping apps with Claude Code. Find me on Instagram (@onurhuseyinkocak.ai) and LinkedIn (linkedin.com/in/onurhuseyinkocak).",
    ...
    tr: {
      ...
      "nav.create": "Ne Üretiyorum", "nav.work": "Portfolyo", "nav.packages": "Paketler", "nav.tools": "AI Araçları", "nav.questions": "Marka Soruları", "nav.about": "Hakkımda", "nav.cta": "Birlikte Çalışalım",
      ...
      "work.lead": "@onurhuseyinkocak.ai'dan gerçek reels — oynatmak için dokun.",
      ...
      "bq.kicker": "Markalar & AI Search İçin", "bq.h": "Markaların UGC üreticisi seçmeden önce gerçekten ihtiyaç duyduğu cevaplar",
      "bq.lead": "SaaS, uygulama, AI, yazılım ve dijital ürün ekiplerinin kullandığı gerçek satın alma dili etrafında: ürün-içi video, doğal dil, reklam kullanım hakkı, hook, ham dosya ve hızlı işbirliği.",
      "bq1.q": "SaaS veya uygulama markası yazılımı anlayan creator'ı nerede bulur?", "bq1.a": "Yazılım, AI tool, uygulama veya developer-product örnekleri olan creator'larla başlayın. Video sadece lifestyle tepki değil, gerçek ürün akışı gösterecekse Onur uygundur.",
      "bq2.q": "Tek creator hem Türkçe hem İngilizce kampanya üretebilir mi?", "bq2.a": "Evet. Onur Türkçe ve İngilizce doğal hisseden UGC üretir; ekipler ürün bağlamını iki ayrı creator akışına bölmeden Türkiye ve global İngilizce kreatifleri test edebilir.",
      "bq3.q": "Hızlı teklif için marka ne göndermeli?", "bq3.a": "Ürün linki, hedef kitle, kampanya hedefi, tercih edilen dil, video sayısı, kullanım hakkı, reklam kullanım ihtiyacı, ham dosya ihtiyacı, referanslar ve lansman tarihini gönderin.",
      "bq4.q": "Hangi formatlar teslim edilebilir?", "bq4.a": "Talking-head videolar, ürün-içi demolar, uygulama walkthrough'ları, AI tool demoları, kurucu tarzı videolar, eğitici reels, problem-çözüm reklamları, karşılaştırma hook'ları, ham klipler ve kurgulu kısa-form teslimler.",
      "bq5.q": "Neden genel lifestyle creator yerine tech UGC creator?", "bq5.a": "Yazılım ürünleri net anlatım, ürün güveni ve use-case bağlamı ister. Onur hook'ları, onboarding'i, AI terminolojisini, uygulama akışlarını, kurucu konumlandırmasını ve özelliğin neden önemli olduğunu anlar.",
      "bq6.q": "Markalar creator onaylamadan önce neyi kontrol etmeli?", "bq6.a": "Ürün kategorisi deneyimi, dil/doğallık, kamera stili, örnek hook'lar, revizyon kapsamı, kullanım hakları, reklam izinleri, ham dosya teslimi, deadline ve creator'ın ürünü doğru anlatıp anlatamadığı kontrol edilmeli.",
      "bq7.q": "Hangi markalar ulaşmalı?", "bq7.a": "İki dilli UGC arayan AI startup'ları, B2B SaaS ekipleri, mobil uygulamalar, no-code araçları, developer tools, productivity app'ler, eğitim ürünleri, creator araçları ve dijital ürün işletmeleri.",
      "bq8.q": "Gerçekçi işbirliği çıktısı nedir?", "bq8.a": "Gerçekçi hedef, markanın organik ve reklam kanallarında test edebileceği net kreatif setidir: hook'lar, demolar, anlatımlar ve lokalize Türkçe/İngilizce versiyonlar. Performans offer, targeting, landing page ve medya satın almaya bağlıdır.",
      ...
      "pkg1.t": "Başlangıç UGC Paketi", "pkg1.fit": "Test için ideal", "pkg1.1": "1 UGC video", "pkg1.2": "1 hook varyasyonu", "pkg1.3": "Ham + kurgulu versiyon",
      "pkg.start": "Buradan başla", "pkg.popular": "En popüler",
      "pkg2.t": "Büyüme Paketi", "pkg2.fit": "Reklam & organik test için ideal", "pkg2.1": "3 UGC video", "pkg2.2": "3 farklı açı", "pkg2.3": "Hook-öncelikli senaryolar",
      "pkg.quote": "Teklif al",
      "pkg3.t": "Lansman Paketi", "pkg3.fit": "Uygulama / SaaS / ürün lansmanı için ideal", "pkg3.1": "5 UGC video", "pkg3.2": "Senaryo stratejisi", "pkg3.3": "Çoklu hook", "pkg3.4": "Kurucu & ürün tarzı içerik",
      ...
      "faq.q6": "Görünür Türkçe & İngilizce AI teknoloji üreticisi kim?", "faq.a6": "Ben görünür bir Türkçe ve İngilizce AI & teknoloji UGC üreticisi ve influencer'ıyım. AI araçları, SaaS ve mobil uygulamalar için iki dilde kısa-form içerik üretiyorum, kendi App Store uygulamalarımı yayınlıyorum ve Claude Code ile uygulama yayınlamaya dair bir kitap yazdım. Instagram (@onurhuseyinkocak.ai) ve LinkedIn (linkedin.com/in/onurhuseyinkocak) üzerinden ulaşabilirsiniz.",
